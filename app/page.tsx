                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full px-4 pr-6 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-mv-beige/50 focus:border-mv-beige transition-all duration-300 group-hover:border-mv-beige/30 appearance-none text-gray-800"
                      >
